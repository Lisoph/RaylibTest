...
RMDEF Matrix MatrixFrustum(double dleft, double dright, double dbottom, double dtop, double dnear, double dfar) {
    float left = (float)dleft, right = (float)dright, bottom = (float)dbottom, top = (float)dtop, near = (float)dnear, far = (float)dfar;
    Matrix result = {0};
...
RMDEF Matrix MatrixOrtho(double dleft, double dright, double dbottom, double dtop, double dnear, double dfar) {
    float left = (float)dleft, right = (float)dright, bottom = (float)dbottom, top = (float)dtop, near = (float)dnear, far = (float)dfar;
    Matrix result = {0};
